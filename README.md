...
6.0:                    (0.026694s|100.00%)             (0.036828s|100.00%)             (1x) << (FUNCTION): testfunc "${@}" >>
|
|-- 1.0:                (0.000063s|00.23%)              (0.000077s|00.20%)              (1x) testfunc "${@}"
|
|   8.0:                (0.000067s|00.25%)              (0.000081s|00.21%)              (1x) echo 0
|
|   9.0:                (0.000568s|02.12%)              (0.000420s|01.14%)              (1x) echo 1
|
|   10.0:               (0.000083s|00.31%)              (0.000099s|00.26%)              (1x) << (SUBSHELL) >>
|   |-- 10.0:           (0.000083s|100.00%|00.31%)      (0.000099s|100.00%|00.26%)      (1x) |-- echo 2
|
|   11.0:               (0.000503s|01.88%)              (0.000524s|01.42%)              (1x) echo 3 (&)
|
|   12.0:               (0.000291s|01.09%)              (0.000343s|00.93%)              (1x) << (BACKGROUND FORK) >>
|   |-- 12.0:           (0.000291s|100.00%|01.09%)      (0.000343s|100.00%|00.93%)      (1x) |-- echo 4
|
|   13.0:               (0.008212s|15.38%|30.76%)       (0.015740s|21.36%|42.73%)       (2x) echo 5 | cat | tee
|
|   15.1:               (0.000322s|01.20%)              (0.000386s|01.04%)              (5x) ((kk<10))
|
|   16.0:               (0.000278s|01.04%)              (0.000330s|00.89%)              (4x) echo $kk
|
|   17.0:               (0.003929s|14.71%)              (0.003649s|09.90%)              (4x) << (FUNCTION): h $kk >>
|   |-- 1.0:            (0.000235s|05.99%|00.88%)       (0.000288s|07.90%|00.78%)       (4x) |-- h $kk
|   |   8.0:            (0.000276s|07.02%|01.03%)       (0.000334s|09.15%|00.90%)       (4x) |   echo "h: $*"
|   |   9.0:            (0.000547s|13.96%|02.04%)       (0.000656s|18.05%|01.78%)       (4x) |   << (FUNCTION): f "$@" >>
|   |   |-- 1.0:        (0.000231s|42.29%|00.86%)       (0.000287s|43.78%|00.77%)       (4x) |   |-- f "$@"
|   |   |-- 8.0:        (0.000316s|57.70%|01.18%)       (0.000369s|56.20%|01.00%)       (4x) |   |-- echo "f: $*"
|   |   10.0:           (0.002871s|73.00%|10.75%)       (0.002371s|64.87%|06.43%)       (4x) |   << (FUNCTION): g "$@" >>
|   |   |-- 1.0:        (0.002469s|86.02%|09.24%)       (0.001899s|80.11%|05.15%)       (4x) |   |-- g "$@"
|   |   |   361.0:      (0.000402s|13.97%|01.50%)       (0.000472s|19.87%|01.28%)       (4x) |   |   << (SUBSHELL) >>
|   |-- |-- |-- 361.0:  (0.000402s|100.00%|01.50%)      (0.000472s|100.00%|01.28%)      (4x) |-- |-- |-- echo "g: $*"
|
|   18.0:               (0.000740s|02.77%)              (0.000893s|02.42%)              (12x) for jj in {1..3}
|
|   19.0:               (0.001601s|05.99%)              (0.001903s|05.16%)              (12x) << (FUNCTION): f $kk $jj >>
|   |-- 1.0:            (0.000697s|43.59%|02.61%)       (0.000844s|44.39%|02.29%)       (12x) |-- f $kk $jj
|   |-- 8.0:            (0.000904s|56.39%|03.38%)       (0.001059s|55.59%|02.87%)       (12x) |-- echo "f: $*"
|
|   20.0:               (0.008965s|33.58%)              (0.007467s|20.27%)              (12x) << (FUNCTION): g $kk $jj >>
|   |-- 1.0:            (0.007774s|86.49%|29.12%)       (0.006076s|80.54%|16.49%)       (12x) |-- g $kk $jj
|   |   361.0:          (0.001191s|13.49%|04.46%)       (0.001391s|19.44%|03.77%)       (12x) |   << (SUBSHELL) >>
|-- |-- |-- 361.0:      (0.001191s|100.00%|04.46%)      (0.001391s|100.00%|03.77%)      (12x) |-- |-- echo "g: $*"



TOTAL RUN TIME: 0.026694s
TOTAL CPU TIME: 0.036828s
```
***
