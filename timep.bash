...
timep_NO_PRINT_FLAG=false
timep_IS_FUNC_FLAG_1=false
timep_REGEN_PID_CHAIN_FLAG=false
...
#trap "${timep_DEBUG_TRAP_STR_0}${timep_DEBUG_TRAP_STR_1}" DEBUG
'
