...
'
    ...
    ${timep_SKIP_DEBUG_FLAG} || {
        ...
        ${timep_IS_BG_FLAG} && declare -f "${timep_LAST_CMD_WORD}" &>/dev/null && ! [[ "${timep_LAST_CMD_WORD}" == '"'"'trap'"'"' ]] && timep_BASH_COMMAND_PREV[${timep_FNEST_CUR}]=" (F) << (FUNCTION): ${timep_BASH_COMMAND_PREV} >>"
