...
* timep 1.4 includes various minor bug fixes and profile refinements, hardens timep against very long command strings, and reduced memory usage by deleting intermediate logs as they were no lionger needed (instead of all at the end)
